...
$exePath = Join-Path $releaseDir "secret-tunnel-v4.exe"
if (!(Test-Path -LiteralPath $exePath)) { $exePath = Join-Path $releaseDir "secret-tunnel-v3.exe" }
if (!(Test-Path -LiteralPath $exePath)) { $exePath = Join-Path $releaseDir "secret-tunnel.exe" }
