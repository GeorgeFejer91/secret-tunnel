...
const DEFAULT_LOCAL_PORT: &str = "8788";
...
mod tests {
    use super::{
        bundled_executable, bundled_mcp_runtime_dir, child_survived_startup,
        clear_zrok_enable_token_environment, stale_zrok_share_tokens_from_json,
        status_probe_path_from_environment, validate_external_url, validate_zrok_token,
    ...
    fn finds_listening_pid_on_local_port() {
        ...
        let output = r#"
  TCP    127.0.0.1:8788         0.0.0.0:0              LISTENING       44648
  TCP    127.0.0.1:1420         0.0.0.0:0              LISTENING       51980
  TCP    [::1]:8788             [::]:0                 LISTENING       44648
"#;
