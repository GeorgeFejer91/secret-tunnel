...
const USER_AGENT: &str = "SecretTunnel-v2";
...
pub const REGISTRATION_URL: &str = "https://github.com/settings/applications/new?oauth_application%5Bname%5D=Secret%20Tunnel%20v2&oauth_application%5Burl%5D=https%3A%2F%2Fgithub.com%2FGeorgeFejer91%2FSecretTunnel-v2&oauth_application%5Bcallback_url%5D=http%3A%2F%2F127.0.0.1%2Fsecret-tunnel%2Funused";
...
mod tests {
    ...
    fn the_registration_url_is_one_well_formed_prefilled_link() {
        ...
        assert!(REGISTRATION_URL.contains("oauth_application%5Bname%5D=Secret%20Tunnel%20v2"));
    }
