...
# Outer ring, violet gradient
$outer = BubblePath $R 1.32
$rect = New-Object System.Drawing.RectangleF([float]($cx - $R), [float]($cy - $R - 60), [float]($R * 2), [float]($R * 2 + 200))
$ringBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush($rect, (C "fcd34d"), (C "b45309"), 55.0)
$blend = New-Object System.Drawing.Drawing2D.ColorBlend(4)
$blend.Colors = @((C "fcd34d"), (C "fb923c"), (C "f43f5e"), (C "9f1239"))
...
$g.FillPath((New-Object System.Drawing.SolidBrush((C "1d1016"))), $inner)
...
$archCx = $cx + 10.0
$floor = $cy + 300.0
$shades = @("2a161c", "45201f", "5f2a1c", "7c2d12", "9a3412", "c2410c", "ea580c", "f97316", "fbbf24", "fffbeb")
$n = $shades.Count
for ($i = 0; $i -lt $n; $i++) {
  $t = $i / [double]($n - 1)
  $w = 660.0 - 560.0 * $t
...
$g.FillEllipse((New-Object System.Drawing.SolidBrush((C "1d1016"))), (New-Object System.Drawing.RectangleF([float]($bx - $br - 20), [float]($by - $br - 20), [float](($br + 20) * 2), [float](($br + 20) * 2))))
$badgeBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush($badgeRect, (C "fb923c"), (C "b45309"), 60.0)
...
$g.DrawString("2", $font, (New-Object System.Drawing.SolidBrush((C "ffffff"))), (New-Object System.Drawing.PointF([float]$bx, [float]($by - 6))), $fmt)
